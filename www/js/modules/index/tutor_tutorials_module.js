        ...
        `;
            ...
            ongoingInfiniteScroll.addEventListener('ionInfinite', async function () {
                if (tutor_tutorials.ongoing_tutor_tutorials_length < tutor_tutorials.get_ongoing_tutor_tutorials().length) {
                    ...
                    tutor_tutorials.ongoing_tutor_tutorials_length = tutor_tutorials.appendPosts(number_of_ongoing_tutor_tutorials_to_add, ongoingInfiniteScroll, tutor_tutorials.ongoing_tutor_tutorials, tutor_tutorials.ongoing_tutor_tutorials_length);
